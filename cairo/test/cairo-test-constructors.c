...
extern void _register_gl_device_creation_changes_context (void);
extern void _register_gl_oversized_surface (void);
extern void _register_gl_surface_source (void);
...
_cairo_test_runner_register_tests (void)
{
    ...
    _register_gl_device_creation_changes_context ();
    _register_gl_oversized_surface ();
    _register_gl_surface_source ();
